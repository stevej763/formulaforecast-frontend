...
export async function createAccount(accountCreationRequest: AccountCreationRequest): Promise<AccountCreationResponse> {
...
export async function login(accountLoginRequest: AccountLoginRequest): Promise<AccountLoginResponse> {
