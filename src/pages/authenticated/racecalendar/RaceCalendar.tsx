...
const RaceCalendar = () => {
	...
	const renderRaceWeekendList = () => {
        ...
        const orderedRaces = raceWeekends.sort((a, b) => new Date(a.raceWeekendStartDate).getTime() - new Date(b.raceWeekendStartDate).getTime());
		return (
	...
	if (error) {
		...
		return (
			<div className="w-full max-w-lg mx-auto bg-gradient-to-br from-gray-900 via-black to-red-900 rounded-xl shadow-lg p-6 mt-4">
				<h2 className="text-3xl font-extrabold mb-6 text-center text-white drop-shadow">Race Calendar</h2>
