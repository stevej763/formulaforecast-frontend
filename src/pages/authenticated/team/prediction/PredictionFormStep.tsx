...
import { getPositionBadge } from "./utilities/getPositionBadge";
import { getDriverName } from "./utilities/getDriverName";
...
const PredictionFormStep = ({ 
  ...
  // Render ordered selection display for top 3 predictions
  const renderTop3SelectionDisplay = () => {
  ...
  return (
    <div className="space-y-6 flex flex-col h-full">
      ...
      <div className="text-center flex-shrink-0">
        ...
        {renderTopThreeSubtitle()}
      </div>

      {/* Ordered Selection Display (for Top 3) */}
      {renderTop3SelectionDisplay()}
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isSelected 
                  ? 'bg-green-600/20 border-2 border-green-500/50 rounded-lg p-4'
                  : 'border-white/20 bg-white/5 hover:border-green-200/50 hover:bg-green-200/10'
                }
              `}
            >
